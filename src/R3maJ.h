...
inline EnvCreateResult EnvCreateFunc(int /*index*/) {
    ...
    components.emplace_back(new SimpleTouchReward(), 55.f);
    components.emplace_back(new SpeedTowardBallReward(), 15.f);
    components.emplace_back(new FaceBallReward(), 1.f);
    components.emplace_back(new GuideAirReward(), 0.25f);
